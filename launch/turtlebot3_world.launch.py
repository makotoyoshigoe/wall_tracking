...
def generate_launch_description():
    ...
    spawn_turtlebot_file_dir = os.path.join(get_package_share_directory('turtlebot3_wall_tracking'), 'launch')
    ...
    spawn_turtlebot_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(spawn_turtlebot_file_dir, 'spawn_turtlebot3.launch.py')
        ),
        launch_arguments={
            'x_pose': x_pose,
            'y_pose': y_pose, 
